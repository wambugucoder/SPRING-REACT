...
public class ChoiceModel implements Serializable {
  ...
  @Column(nullable = false) private String option;
  ...
  public void setOption(String choices) { this.option = choices; }

  public List<VotesModel> getIncomingvotes() { return incomingvotes; }

  public void setIncomingvotes(List<VotesModel> votes) {
    this.incomingvotes = votes;
  }

  public PollModel getPolls() { return polls; }

  public void setPolls(PollModel polls) { this.polls = polls; }
}
