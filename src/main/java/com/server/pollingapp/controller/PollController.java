...
public class PollController implements SecuredController {
  ...
  @PostMapping(value = "/api/v1/polls/{userId}/non_scheduled_poll",
               produces = MediaType.APPLICATION_JSON_VALUE,
               consumes = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<UniversalResponse>
  NonScheduledPoll(@RequestBody
                   @Valid NonScheduledPollRequest nonScheduledPollRequest,
  ...
  @PostMapping(value = "/api/v1/polls/{userId}/scheduled_poll",
               produces = MediaType.APPLICATION_JSON_VALUE,
               consumes = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<UniversalResponse>
  ScheduledPoll(@RequestBody @Valid ScheduledPollRequest scheduledPollRequest,
                @PathVariable String userId, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      UniversalResponse universalResponse = new UniversalResponse();
      universalResponse.setMessage("Please check the details you provided");
  ...
  @GetMapping(value = "/api/v1/polls/opened_polls",
              produces = MediaType.APPLICATION_JSON_VALUE)
  public List<PollModel>
  GetAllOpenPolls() {
    return pollService.GetAllOpenPolls(PollStatus.POLL_OPENED);
  }

  @GetMapping(value = "/api/v1/polls/closed_polls",
              produces = MediaType.APPLICATION_JSON_VALUE)
  public List<PollModel>
  GetAllClosedPolls() {
  ...
  @GetMapping(value = "/api/v1/polls/scheduled_polls",
              produces = MediaType.APPLICATION_JSON_VALUE)
  public List<PollModel>
  GetAllScheduledPolls() {
    return pollService.GetScheduledPolls(PollsCategory.SCHEDULED_POLL);
  }

  @GetMapping(value = "/api/v1/polls/specific_poll/{pollId}",
              produces = MediaType.APPLICATION_JSON_VALUE)
  public Object
  GetSpecificPoll(@PathVariable String pollId) {
    return pollService.GetPollById(pollId);
  }

  @PostMapping(value = "/api/v1/polls/cast_vote/{userId}/{pollId}/{choiceId}",
               produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<UniversalResponse>
  CastVote(@PathVariable String choiceId, @PathVariable String pollId,
