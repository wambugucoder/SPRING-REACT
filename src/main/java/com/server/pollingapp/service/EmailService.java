...
public class EmailService {
  ...
  @Value("${app.frontend}") private String website;

  @Value("${app.email}") private String emailToBeUsed;
  ...
  public void createActivationTemplate(String token, UserModel userModel) {
    ...
    HtmlTextEmail htmlTextEmail =
        builder.header(header)
            .and()
            .logo("https://www.rocketbase.io/img/logo-dark.png", "", 0, 41)
            .and()
            .addText("Welcome," + userModel.getUsername() + "!")
            .fontWeight(FontWeight.BOLD)
            .center()
            .and()
            .addText(
                "Thanks for Registering with Votex. We’re thrilled to have you on board. To get started you will need to verify your Account:")
            .and()
            .addButton("Verify Account",
                       "https://localhost:8443/api/v1/auth/activate/" + token)
            .color(ColorPalette.FRENCH_BLUE)
            .and()
            .addHtml(
            ...
            .and()
            .addText(" Cheers, The Votex Team ")
            .and()
            .copyright("votex")
            .url(website)
            .and()
            .addPlainTextFooter("[Votex, LLC],"
                                + "1234 Street Rd,"
                                + "Suite 1234")
            .and()
            .addImage("https://cdn.rocketbase.io/assets/loading/no-image.jpg",
                      "", 100, 0)
            .linkUrl(website)
            .and()
            .build();
  ...
  public void SendAccountActivationEmail(HtmlTextEmail htmlTextEmail,
                                         UserModel userModel) {
